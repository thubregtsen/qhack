...
print(k.probs_qnode.draw())

print("params = np.array(", np.array2string(params, separator=","), ")")

print("W = np.array(", np.array2string(W, separator=","), ")")
